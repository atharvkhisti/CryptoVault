package com.cryptovault.risk.security;
 ...
 * <p><b>Banking Relevance:</b> Propagates critical security identity fields (userId, email, roles) through the microservices network without exposing DB credentials.</p>
 * <p><b>Scalability Considerations:</b> Highly scalable as context construction runs in-memory with zero DB lookups.</p>
 * <p><b>Interview Talking Points:</b> Reconstructs a valid Spring Security <code>UsernamePasswordAuthenticationToken</code> using the custom <code>JwtUserPrincipal</code> payload.</p>
 */
@Component
