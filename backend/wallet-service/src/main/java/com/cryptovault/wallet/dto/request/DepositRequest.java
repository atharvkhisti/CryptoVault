...
/**
 * DTO containing parameters required to deposit assets into a wallet.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request body payload for performing a deposit")
public class DepositRequest {
    ...
    @Schema(description = "Deposit quantity amount (must be positive)", example = "150.50", requiredMode = Schema.RequiredMode.REQUIRED)
