package com.cryptovault.wallet.dto.response;
...
/**
 * DTO representing wallet balance and currency status details returned to clients.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Wallet account details and balance representation")
