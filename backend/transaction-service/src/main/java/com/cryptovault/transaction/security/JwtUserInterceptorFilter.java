package com.cryptovault.transaction.security;
...
/**
 * Filter that intercepts incoming HTTP requests, decodes the JWT access token from the Authorization header,
 * extracts user identity claims, and initializes the SecurityContext.
 */
@Component
